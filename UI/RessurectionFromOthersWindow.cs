...
namespace Aion.isxAion
{
    ...
    {
        #region Constructors
        public RessurectionFromOthersWindow(LavishScriptObject Obj) : base(Obj)
        {
        }
        ...
        public AionButton Accept
        {
            get { return new AionButton(GetMember("Accept")); }
        }

        public AionButton Decline
        {
            get { return new AionButton(GetMember("Decline")); }
        }
        #endregion
        #endregion
    }
